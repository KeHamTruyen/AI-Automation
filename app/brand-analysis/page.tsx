    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          <Badge className="mb-4 bg-blue-100 text-blue-700">🎯 Phân tích thương hiệu AI</Badge>
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            AI phân tích sâu định hướng, phong cách và nội dung phù hợp với thương hiệu của bạn. Từ đó đưa ra chiến lược
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Quy trình phân tích thương hiệu</h2>
            <p className="text-xl text-gray-600">AI phân tích thương hiệu qua 4 bước đơn giản</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">1. Thu thập thông tin</h3>
              <p className="text-gray-600">Nhập thông tin cơ bản về thương hiệu, sản phẩm và mục tiêu</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">AI xử lý và phân tích dữ liệu để hiểu sâu về thương hiệu</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Sinh ra báo cáo chi tiết về chân dung và chiến lược thương hiệu</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Lightbulb className="w-8 h-8 text-orange-600" />
              </div>
              <h3 className="text-lg font-semibold mb-2">4. Đề xuất chiến lược</h3>
              <p className="text-gray-600">Cung cấp gợi ý nội dung và chiến lược marketing cụ thể</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <TabsContent value="step-1">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Cung cấp thông tin cơ bản để AI hiểu về thương hiệu của bạn</CardDescription>
                  </CardHeader>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            <SelectItem value="startup">Startup (1-10 người)</SelectItem>
              ...
              <TabsContent value="step-2">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Xác định mục tiêu marketing và đối tượng khách hàng mục tiêu</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                      <Label htmlFor="marketing-goals">Mục tiêu marketing chính *</Label>
              ...
              <TabsContent value="step-3">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Cung cấp thông tin về nội dung và kênh truyền thông đang sử dụng</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="competitors" placeholder="Tên các đối thủ cạnh tranh (cách nhau bằng dấu phẩy)" />
                    </div>
                ...
                {isAnalyzing ? (
                  <Card>
                    <CardContent className="py-16 text-center">
                      ...
                      <h3 className="text-xl font-semibold mb-4">AI đang phân tích thương hiệu của bạn...</h3>
                      <p className="text-gray-600 mb-6">
                        Quá trình này có thể mất vài phút. AI đang xử lý và phân tích dữ liệu để tạo ra báo cáo chi
                        tiết.
                      </p>
                  ...
                  <div className="space-y-8">
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>AI đã hoàn thành phân tích chân dung thương hiệu của bạn</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="text-center p-4 bg-blue-50 rounded-lg">
                            <div className="text-3xl font-bold text-blue-600 mb-2">92%</div>
                            <div className="text-sm text-gray-600">Độ chính xác phân tích</div>
                          </div>
                          <div className="text-center p-4 bg-green-50 rounded-lg">
                            <div className="text-3xl font-bold text-green-600 mb-2">15</div>
                            <div className="text-sm text-gray-600">Insights được tạo</div>
                          </div>
                          <div className="text-center p-4 bg-purple-50 rounded-lg">
                            <div className="text-3xl font-bold text-purple-600 mb-2">8</div>
                            <div className="text-sm text-gray-600">Chiến lược đề xuất</div>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Phân tích tính cách và đặc điểm của thương hiệu</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-6">
                          <div className="space-y-4">
                            ...
                            <p className="text-sm text-gray-600 ml-4">
                              Thương hiệu thể hiện sự chuyên nghiệp cao, đáng tin cậy trong lĩnh vực công nghệ
                            </p>
                          </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-sm text-gray-600 ml-4">
                              Cách giao tiếp gần gũi, dễ tiếp cận, tạo cảm giác thân thiện với khách hàng
                            </p>
                          </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-sm text-gray-600 ml-4">
                              Thương hiệu có xu hướng sáng tạo, đổi mới trong cách tiếp cận và giải pháp
                            </p>
                          </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-sm text-gray-600 ml-4">
                              Khách hàng có thể tin tưởng vào chất lượng sản phẩm và dịch vụ
                            </p>
                          </div>
                        </div>
                      </CardContent>
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Gợi ý về loại nội dung và cách tiếp cận phù hợp</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <div className="space-y-2">
                              <Badge variant="secondary">Chuyên nghiệp nhưng thân thiện</Badge>
                              <Badge variant="secondary">Giải thích đơn giản</Badge>
                              <Badge variant="secondary">Tích cực và động viên</Badge>
                            </div>
                            <p className="text-sm text-gray-600 mt-3">
                              Sử dụng ngôn ngữ chuyên nghiệp nhưng dễ hiểu, tránh thuật ngữ phức tạp
                            </p>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              <div className="flex items-center justify-between">
                                ...
                                <Badge className="bg-green-100 text-green-700">Cao</Badge>
                              </div>
                              <div className="flex items-center justify-between">
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Nền tảng phù hợp nhất cho thương hiệu của bạn</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-4">
                          <div className="flex items-center justify-between p-4 border rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">Phù hợp cho B2B và nội dung chuyên nghiệp</p>
                              </div>
                            </div>
                            <Badge className="bg-green-100 text-green-700">Ưu tiên cao</Badge>
                          </div>
                          ...
                          <div className="flex items-center justify-between p-4 border rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">Tốt cho community building và customer support</p>
                              </div>
                            </div>
                            <Badge className="bg-green-100 text-green-700">Ưu tiên cao</Badge>
                          </div>
                          ...
                          <div className="flex items-center justify-between p-4 border rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">Lý tưởng cho tutorial và demo sản phẩm</p>
                              </div>
                            </div>
                            <Badge className="bg-blue-100 text-blue-700">Ưu tiên trung bình</Badge>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Những hành động cụ thể để cải thiện thương hiệu</CardDescription>
                      </CardHeader>
                      <CardContent>
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                Lập kế hoạch nội dung 30 ngày với focus vào tutorial và case study
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">Tăng tần suất đăng bài và tương tác trên LinkedIn</p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            <CheckCircle className="w-5 h-5 text-green-600 mt-0.5" />
                  ...
                  <Card>
                    <CardContent className="py-16 text-center">
                      ...
                      <h3 className="text-xl font-semibold mb-4">Chưa có kết quả phân tích</h3>
                      <p className="text-gray-600 mb-6">
                        Vui lòng hoàn thành các bước trước để xem kết quả phân tích thương hiệu.
                      </p>
                      <Button onClick={() => setAnalysisStep(1)}>Bắt đầu phân tích</Button>
                    </CardContent>
                  </Card>
                )}
              </TabsContent>
