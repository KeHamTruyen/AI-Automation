...
import { Brain, Upload, BarChart3, Lightbulb, Eye, ArrowLeft, Home } from "lucide-react";
...
export default function BrandAnalysisClient() {
  ...
  return (
    <div>
      {/* Header (merged from original root page) */}
              ...
              <BreadcrumbList>
                <BreadcrumbItem>
                  <BreadcrumbLink asChild>
                    <Link href="/" className="flex items-center"><Home className="w-4 h-4" /></Link>
                  </BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator />
                <BreadcrumbItem>
